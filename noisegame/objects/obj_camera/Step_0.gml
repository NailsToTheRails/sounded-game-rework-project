...
if (instance_exists(obj_sound))
{
   ...
   // camera_zoom(1, 0.00035)
    ...
    camera_set_view_pos(view_camera[0], lerp(cam_x, camera_get_view_x(view_camera[0]), 0.7), (lerp(cam_y, camera_get_view_y(view_camera[0]), 0.7) + irandom_range((-shake_mag), shake_mag)))
	camera_set_view_size(view_camera[0], 500/targetzoom, 500/targetzoom	)
