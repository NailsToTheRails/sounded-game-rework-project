...
layer_x(layer_get_id("Background_still"), cam_x)
layer_y(layer_get_id("Background_still"), cam_y)

layer_x(layer_get_id("Background_cloud"), lerp(0, cam_x, parallax_values[_j][0]) + scrollx)
layer_y(layer_get_id("Background_cloud"), lerp(0, cam_y, parallax_values[_j][1]) + sine_wave(current_time / 6000, 1, 1, 0))

if room_just_changed && parallax_debug
{
